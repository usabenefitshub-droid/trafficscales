        ...
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" className="w-4 h-4 mt-0.5 rounded border-white/20 bg-dark-800 text-brand-blue" required />
              <span className="text-sm text-gray-400">
                I agree to the{' '}
                <Link to="#" className="text-brand-blue hover:text-brand-purple">Terms of Service</Link>
                {' '}and{' '}
                <Link to="#" className="text-brand-blue hover:text-brand-purple">Privacy Policy</Link>
              </span>
            </div>
